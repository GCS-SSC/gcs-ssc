...
export const ENTITY_AUTHORIZATION_POLICIES = {
  ...
  fundingcaseintake: createMetadata({ subject: 'funding_case', ownerResolver: 'funding_case', ownerColumn: 'egcs_fi_fundingopportunity', creationParent: 'funding_opportunity', allowedScopes: ['global', 'agency', 'program'], table: 'Funding_Case_Intake_Profile', statusColumn: 'egcs_fi_status' }, null, ['Intake', 'Réception']),
