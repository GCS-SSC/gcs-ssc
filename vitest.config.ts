...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: '#build/ui-image-component', replacement: fileURLToPath(new URL('./tooling/gcs-ssc/tests/fixtures/nuxt-ui-image.ts', import.meta.url)) },
      { find: '#build/app.config', replacement: fileURLToPath(new URL('./tooling/gcs-ssc/tests/fixtures/nuxt-app-config.ts', import.meta.url)) },
