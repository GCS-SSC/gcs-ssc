...
import { AgencyMonitorTypeSchema, type AgencyMonitorTypeItem } from '~~/shared/types/schemas'
...
<template>
  <CommonResourceCrud
    :title="t('agency.tabs.monitor_types')"
    icon="i-lucide-clipboard-check"
    :fetch-url="`/api/agency/${agencyId}/monitor-types`"
    :post-url="canCreate ? `/api/agency/${agencyId}/monitor-types` : undefined"
    :update-url-base="canUpdate ? '/api/agency/monitor-types' : undefined"
    :delete-url-base="canDelete ? '/api/agency/monitor-types' : undefined"
