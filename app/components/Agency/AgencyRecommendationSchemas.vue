...
const { agencyId, canUpdateChild } = defineProps<{
  agencyId: string
...
const initialNewItem: Partial<AdminCommonGenericItem> = { egcs_cn_result: {} }
const resourceUrl = `/api/agency/${agencyId}/recommendation-schemas`
</script>
...
<template>
  <AdminCommonManagerTab
    ...
    :schema="CommonRecommendationSchemaCreateSchema.omit({ egcs_cn_agency: true }).strict()"
    :columns="columns"
