...
/** Add Agreement relationship classification and its write guards. */
...
/** Preserve authored relationship classifications on rollback. */
export const down = async (_db: Kysely<Database>): Promise<void> => {
  throw new Error('0018_agreement_proponent_type is forward-only; restore a backup to roll back')
}
