...
export const AUDIT_TABLE_OWNERSHIP: Readonly<Record<string, AuditOwnershipRule>> = {
  ...
  'public.Agency_Chart_of_Account': parent('egcs_ay_organizationagency', 'public.Agency_Profile'),
  'public.Agency_Commitment_Type': parent('egcs_ay_organizationagency', 'public.Agency_Profile'),
  ...
  'public.Agency_Document_Template': parent('egcs_ay_organizationagency', 'public.Agency_Profile'),
  ...
  'public.Common_Attachment': { kind: 'references', links: [
    ...
    { table: 'public.Agency_Document_Template', column: 'egcs_ay_templateattachment_en' },
    { table: 'public.Agency_Document_Template', column: 'egcs_ay_templateattachment_fr' }
  ] },
