...
export const AUDIT_TABLE_OWNERSHIP: Readonly<Record<string, AuditOwnershipRule>> = {
  ...
  'public.Common_Approval_Template': entity('egcs_cn_scopeid', 'egcs_cn_scopetype'),
  ...
  'public.Common_Publication_Selection_Lock': { kind: 'encoded-entity', column: 'egcs_cn_key', dimensionColumn: 'egcs_cn_dimension', segments: { scope: 2, scope_entity_purpose: 4 } },
  ...
  'public.Common_Recommendation_Set_Setup': entity('egcs_cn_scopeid', 'egcs_cn_scopetype'),
  ...
  'public.Common_Review_Set_Setup': entity('egcs_cn_scopeid', 'egcs_cn_scopetype'),
  ...
  'public.Common_Workflow_Member_Condition': parent('member_id', 'public.Common_Workflow_Setup_Member'),
  'public.Common_Workflow_Owner_Blocker': parent('egcs_cn_workflowrun', 'public.Common_Workflow_Run'),
  'public.Common_Workflow_Publication_Condition': parent('version_id', 'public.Common_Publication_Version'),
  ...
  'public.Common_Workflow_Setup': entity('egcs_cn_scopeid', 'egcs_cn_scopetype'),
  ...
  'public.Transfer_Payment_Stream_Field': parent('egcs_tp_transferpaymentstream', 'public.Transfer_Payment_Stream'),
  'public.Transfer_Payment_Stream_Field_Option': parent('field_id', 'public.Transfer_Payment_Stream_Field'),
