import { validateReviewSetApprovalTemplateForAgency, validateReviewSetApprovalTemplatesForAgency } from '~~/server/utils/agency-review-set-dependencies'
...
export default defineEventHandler(async event => {
   ...
   */
    ...
    const hasValidReviewSchemas = uniqueReviewSchemaIds.length === 0
      ? true
      : await validateReviewSchemasForAgency(trx, agencyId, uniqueReviewSchemaIds.map(schemaId => ({
