...
import { createAgencyRecommendationMemberSchema } from '~~/server/utils/recommendation-set-agency-routes'
...
export default defineEventHandler(async event => {
  ...
  return await createAgencyRecommendationMemberSchema(event)
})
